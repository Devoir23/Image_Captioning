...
# LOADING DATA
vocab = pickle.load(open('vocab\\vocab_coco.file', 'rb'))
...
def get_caption_model():
    ...
    try:
        caption_model.load_weights('weights\image_captioning_coco_weights.h5')
    except FileNotFoundError:
        caption_model.load_weights('Image-Captioning/weights/image_captioning_coco_weights.h5')
